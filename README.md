...
![Top Specializations](visualizations/top_specializations.png)
...
![Source Comparison](visualizations/source_comparison.png)
...
![Price Segments](visualizations/price_segments.png)
...
![Ratings Distribution](visualizations/ratings_distribution.png)
...
![Consultation Formats](visualizations/consultation_formats.png)
...
│   ├── assignment2_pipeline.py               # Single-source pipeline
│   └── assignment2_multi_source_pipeline.py  # Full multi-source pipeline
│
├── 📊 data/
│   ├── raw/                                  # Original scraped data per source
...
│   ├── dataset_statistics.md                 # Statistical summary
│   ├── dataset_summary.txt
...
```bash
python scripts/assignment2_multi_source_pipeline.py
```
...
```bash
python scripts/parse_doctor_kz.py
# or with page limit:
python scripts/parse_doctor_kz.py --max-pages 5
```
